        ...
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-28">
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-xl">
              ...
              knowledge, you’re in the right place. Our resources are crafted to
              guide you through each step, making complex topics accessible and
              engaging.
            </p>
          ...
          <button className="btn mt-6 w-full  btn-secondary font-bold text-md">
            Get Started
