...
const Navbar = () => {
  ...
  // dark mode theme code starts here
  ...
  // dark mode theme code ends here
        ...
        <div className="navbar ">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dark:bg-[#181C14] dark:text-white dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow"
              >
                {navItems}
              </ul>
            </div>
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="navbar-end">
              <a
                className=" text-white dark:bg-pink-500 bg-black font-bold cursor-pointer hover:bg-slate-700 duration-200 px-5 py-3 rounded-lg"
                onClick={() =>
